...
function Dashboard() {
  ...
  return (
    <div>
        <div className='w-full px-8 sm:px-10 w-full py-6 h-[10vh] flex items-center justify-between rounded-lg border-2 border-gray-300 '>
            <div className='rounded-full w-5 sm:w-[25vh] flex flex-col items-center justify-center'>
                <p className='text-gray-500 font-bold text-[20px] sm:text-[35px]'>{availableVehicles}</p>
                <p className='text-gray-500 font-bold text-[10px] sm:text-[15px]'>Available Vehicles</p>
            </div>
            <div className=' rounded-full w-5  sm:w-[25vh] flex flex-col items-center justify-center'>
                <p className='text-gray-500 font-bold text-[20px] sm:text-[35px]'>{availableDrivers}</p>
                <p className='text-gray-500 font-bold text-[10px] sm:text-[15px]'>Available Drivers</p>
            </div>

            <div className=' rounded-full w-5  sm:w-[25vh] flex flex-col items-center justify-center'>
                <p className='text-gray-500 font-bold text-[20px] sm:text-[35px]'>{ongoingRequests}</p>
                <p className='text-gray-500 font-bold text-[10px] sm:text-[15px]'>Ongoing Requests</p>
            </div>

             <div className=' rounded-full w-5 sm:w-[25vh] flex flex-col items-center justify-center'>
                <p className='text-gray-500 font-bold text-[20px] sm:text-[35px]'>{pendingRequests}</p>
            ...
            <div className='flex'>
             ...
             <div className='flex'>
                <div className='px-1'>
                    ...
                    className='text-gray-500 font-bold text-[9px] sm:text-[12px] hover:text-gray-400 duration-300 transition-colors cursor-pointer'>Manage Requests</p>
                </div>
