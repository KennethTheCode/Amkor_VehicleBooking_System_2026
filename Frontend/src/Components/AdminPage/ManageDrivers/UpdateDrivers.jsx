...
function UpdateDrivers({ id, drivers, onUpdated }) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/ManageDrivers/EditDrivers.php`, {
                method: "POST",
                body: formData,
            })
                ...
                <div className="bg-black/20 fixed flex items-center justify-center h-screen inset-0 z-100">
                    <form
                        ...
                        <div className="p-5 border-b-2 border-blue-800">
                            <p className="font-bold">Edit Driver</p>
                        </div>
                        ...
                        <div className="p-5 flex flex-col gap-3">
                            ...
                            <div>
                                <p className="text-gray-800 font-bold text-[13px]">License No.</p>
                                <input
                                    type="text"
                                    name="license_no"
                            ...
                            <div>
                                <p className="text-gray-800 font-bold text-[13px]">Expiration Date</p>
                                <input
                                    type="date"
